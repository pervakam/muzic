	...
	data() {
		return {
			...
			profile: {
				...
				cat: 'ПЛЕЙЛИСТ',
				price: 123,
				desc: 'Уделяя особое внимание року, гранжу, стоунеру, экстремальному металлу, металлу, хардкору и панк-року, мы стремимся продвигать и пробиваться сквозь барьеры всех видов тяжелой и экстремальной музыки по всему миру. <br><br>Мы верим в силу музыки и будем сотрудничать с группами и музыкантами, которые вносят свой вклад в наше дело. Мы хотим предоставить публике и художнику уникальный способ восприятия искусства. Мы очень рады сделать этот шаг к организованной, устойчивой, единой сцене и, прежде всего, включенной и без каких-либо предубеждений и различий!'
			},
			socialList: [
				{
					name: 'yandex',
